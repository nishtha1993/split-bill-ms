...
1. models: For defining all the data models we will be using throughout this project
2. apis: For defining all of the api paths (or controllers)
3. services: For creating the core logic used by each api
4. utils: For creating utility functions
