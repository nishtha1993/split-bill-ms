...
3. /generateSharableLink: AWS SES (see this reference https://docs.aws.amazon.com/ses/latest/dg/send-an-email-using-sdk-programmatically.html#send-using-sdk-python-procedure)
